...
<body id="page-top">
  ...
  <script src="${pageContext.request.contextPath}/resource/static/demo1/lib/bootstrap-admin-template/js/demo/chart-pie-demo.js"></script>
      ...
      <!-- Page level plugins -->
    <script src="${pageContext.request.contextPath}/resource/static/demo1/lib/bootstrap-admin-template/vendor/datatables/jquery.dataTables.min.js"></script>
    <script src="${pageContext.request.contextPath}/resource/static/demo1/lib/bootstrap-admin-template/vendor/datatables/dataTables.bootstrap4.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="${pageContext.request.contextPath}/resource/static/demo1/lib/bootstrap-admin-template/js/demo/datatables-demo.js"></script>
