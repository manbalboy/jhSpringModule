...
<script src="${pageContext.request.contextPath}/resource/static/demo1/lib/bootstrap-4.5.0-dist/js/bootstrap.bundle.min.js" ></script>
<%-- <script src="${pageContext.request.contextPath}/resource/static/demo1/lib/popper/popper.min.js" ></script> --%>
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resource/static/demo1/lib/bootstrap-4.5.0-dist/css/bootstrap.min.css" />
  ...
  <link href="${pageContext.request.contextPath}/resource/static/demo1/lib/bootstrap-admin-template/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
  <link href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">

  <!-- Custom styles for this template-->
  <link href="${pageContext.request.contextPath}/resource/static/demo1/lib/bootstrap-admin-template/css/sb-admin-2.min.css" rel="stylesheet">
